...
buttons = {
    ...
    "tr": {
        ...
        "btn_stop": "⛔ Durdur",
        "btn_location": "📍 Adresimiz",
        "btn_aboutus": "🏫 Hakkımızda",
...
messages = {
    "uz": {
        ...
        "education_center_address": "<b>Turan Ta'lim manzili:</b>\n\nFarg'ona viloyati, Farg'ona shahar\n\nMo'ljal: Ixlos savdo majmuasi 3-qavat\n\n<b>Aloqa uchun:</b> <code> +998 (90) 846-8188 </code>",
        "choose_lang": "🌍 Iltimos, tilni tanlang:\n\n🇺🇿 O'zbekcha | 🇹🇷 Türkçe",
        "about_start": "Assalomu alaykum <b> Turan Ta'lim </b> uchun maxsus ishlab chiqarilgan botimizga xush kelibsiz! Ijtimoiy tarmoqlarimizga obuna bo'lishni unutmang👇👇",
        ...
        "start_command": "<b> 🤖 AI Chatbotimiz bilan suhbatni boshlash uchun /chat buyrug'ini yuboring yoki pastdagi tugmalardan foydalaning. \n\n ❌ Chiqish uchun /stop ni yuboring.</b>",
        ...
        "not_supported_media": "Kechirasiz, hozircha video va rasm formatidagi ma'lumotlar qo'llab-quvvatlanmaydi.",
    },
    
    "tr": {
        "voice_response": "🔊 Sesli mesaj",
        "education_center_address": "<b>Turan Ta'lim adresi:</b>\n\nFergana bölgesi, Fergana şehri\n\nDönüm noktası: İkhlos alışveriş kompleksi, 3. kat\n\n<b>İletişim için:</b> <code> +998 (90) 846-8188 </code>",
        "about_start": "Merhaba, <b>Turan Ta'lim</b> özel olarak tasarlanmış botumuza hoş geldiniz! Sosyal ağlarımıza abone olmayı unutmayın👇👇",
        ...
        "time_waiter": "Server hozir band kutish vaqti: {minute}",
        "not_supported_media": "Üzgünüz, şu anda video ve resim formatındaki veriler desteklenmiyor.",
    }
}